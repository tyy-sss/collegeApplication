  ...
  <div class="school">
    <div class="show-container">
      ...
      <div class="context">
        <div class="item" @click="checkSchoolNews">
          ...
          <div>
            <el-button type="warning" @click="changeSchool"
              >修改</el-button
            >
            <el-button type="danger" @click="deleteSchool"
              >删除</el-button
            >
          </div>
        </div>

        <div class="item" @click="form.dialogVisible = true">
          <div class="add">
    ...
    >
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-form-item label="学校姓名" prop="name">
