 ...
 * @LastEditTime: 2024-01-20 15:16:14
    ...
    <div class="box">
        ...
        <div class="item">
          ...
          <div class="condition_list">
            ...
            <div
              ...
              :key="i"
              :class="item.name == data.curProvince ? 'tag_item select' : 'tag_item'"
        ...
        <div class="item">
          ...
          <div class="condition_list">
            ...
            <div
              ...
              :key="i"
              :class="item.name == data.curSchool ? 'tag_item select' : 'tag_item'"
        ...
        <div class="item">
          ...
          <div class="condition_list">
            ...
            <div
              ...
              :key="i"
              :class="item.name == data.curMajor ? 'tag_item select' : 'tag_item'"
      ...
      <div class="stack-line" v-loading.lock="data.loading">
        <div class="stack-info">
          ...
          <hr />
          <div class="gk-rank">
            <div class="item"><span>同分人数</span>{{ data.gkNum || "-" }}人</div>
            <div class="item">
